...
local trainHook = function(self, path)
   ...
   --local input_HR = input;
   local input_HR = image.scale(input, opt.wild,opt.high,'bicubic') 
   ...
   --local input_y2=image.rgb2y(input)
    input_LR = image.scale(input_HR,opt.wild/opt.scale,opt.high/opt.scale, 'bicubic')
