...
--    image.save(string.format('%s/fake_%04d.png',opt.result_path,cnt),image.toDisplayTensor(fake_p))
--    image.save(string.format('%s/fake_%04d.png',opt.result_path,cnt),image.rgb2y(fake_p))
