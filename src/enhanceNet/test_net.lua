...
--local modelG = torch.load('./model/xj_high_rate_500.t7'):type(dtype)
--print(modelG)
modelG = modelG:cuda()
modelG = modelG:float()
torch.save('./model/test.t7', modelG )
...
local fGx=function(x)
    GmodelG:zeroGradParameters()
    lGabel:fill(real_label)
...
--        modelG:float()
        ...
        torch.save('./model/sr_xj_' .. epoch .. '.t7', modelG )
