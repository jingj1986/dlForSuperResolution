...
--  t_folder = '/data/images_lib/xiju/x2_rm/high/',
  t_folder = '/data/images_lib/DIV2K/high/',
  --model_folder='./model/',
  backend = 'cuda',
  use_cudnn = 1,
}
...
--local modelG = torch.load('./model/enh_sdl_x4_384_500.t7'):type(dtype)
print(modelG)
...
--        modelG:float()
        ...
        torch.save('./model/x2_div_mse_' .. epoch .. '.t7', modelG:clearState() )
