...
opt = {
  ...
  --t_folder = '/data/images_lib/video/sidalin/high/',
  --t_folder = '/home/user/data/video/hongxing/high/',
  t_folder = '/data/images_lib/xiju/1024/high/',
  --t_folder = '/home/user/data/video/xiaobingzhangga/train/high/',
  --model_folder='./model/',
  backend = 'cuda',
  use_cudnn = 1,
}
...
local modelG = torch.load('./model/l1_300.t7'):type(dtype)
--print(modelG)
...
--        modelG:float()
        ...
        torch.save('./model/zhangga_' .. epoch .. '.t7', modelG )
